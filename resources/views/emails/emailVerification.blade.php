        ...
        <td class="text-center p-3 p-md-5">
            <div class="d-inline-block border-radius-0 w-100" style="max-width:600px; border:1px solid #e3b504; background-color:#ffffff">
                <div class="text-start px-3 px-md-4 pt-4 pb-5">
                    ...
                    <p>Thank you for being with us! To verify your email address, please use the following One-Time Pin (OTP):</p>
                    <p>OTP: <span class="fw-bold" style="font-size:22px; letter-spacing:2px">{{ $data['otp'] }}</span></p>
                    <p>Please enter this OTP on the dialog you just opened in the website to confirm your email address.</p>
                    <p>If you did not start this email verification, please ignore this email.</p>
