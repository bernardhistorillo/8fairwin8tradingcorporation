    ...
    <div class="modal-dialog modal-success" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary proceed" data-dismiss="modal">Okay</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-success" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success proceed" style="background-color:#0e4d22; color:#ffffff">Confirm</button>
            </div>
        </div>
    </div>
</div>
