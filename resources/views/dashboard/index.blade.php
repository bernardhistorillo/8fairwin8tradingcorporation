            ...
            <div class="animated fadeIn">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <div
                                    style="display:inline-block; border-radius:50%; border:4px solid #0e4d22; width:100px; height:100px; padding-top:17px">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-12 col-lg-6">
                        <div class="card">
                            <div class="card-body p-3 d-flex align-items-center">
                                <i class="fas fa-gem p-3 font-2xl mr-3"
                                   style="background-color:#0e4d22; color:#ffffff"></i>
                                <div>
                                    <div class="text-value-sm"
                                         style="color:#0e4d22; font-size:1.5em; line-height:0.9em; margin-top:3px">
                                        <span
                                            id="winners-gem-balance">{{ number_format($income['gemBalance'], 2) }}</span>
                                        <i class="fas fa-gem" style="font-size:0.8em"></i>
                                        <span style="font-size:0.7em"> &nbsp;=&nbsp; &#8369;&nbsp;<span
                                                id="winners-gem-balance-in-pesos">{{ number_format($income["gemBalance"] * $winnersGemValue, 2) }}</span></span>
                                    </div>
                                    <div class="text-muted text-uppercase font-weight-bold small"
                                         style="margin-top:4px">Winners Gem
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-6" style="border-right:1px solid #dddddd">
                                        <a class="btn-block text-muted d-flex justify-content-between align-items-center"
                                           href="!#" data-toggle="modal" data-target="#modal-gem-purchase">
                                    ...
                                    <div class="col-6" style="border-left:1px solid #dddddd">
                                        <a class="btn-block text-muted d-flex justify-content-between align-items-center"
                                           href="javascript:void(0)" data-toggle="modal" data-target="#modal-convert">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="card">
                            <div class="card-body p-3 d-flex align-items-center">
                                <i class="fa fa-money-bill-alt p-3 font-2xl mr-3"
                                   style="background-color:#0e4d22; color:#ffffff"></i>
                                <div>
                                    <div class="text-value-sm" style="color:#0e4d22; font-size:1.5em">&#8369; <span
                                            id="peso-balance">{{ number_format($income["pesoBalance"], 2) }}</span>
                                    </div>
                            ...
                            <div class="card-footer px-3 py-2">
                                <div class="row">
                                    <div class="col-6" style="border-right:1px solid #dddddd">
                                        <a class="btn-block text-muted d-flex justify-content-between align-items-center"
                                           href="javascript:void(0)" data-toggle="modal" data-target="#modal-withdraw">
                                    ...
                                    <div class="col-6" style="border-left:1px solid #dddddd">
                                        <a class="btn-block text-muted d-flex justify-content-between align-items-center"
                                           ...
                                           data-target="#modal-pool-share-contribute">
                        ...
                        <div class="card">
                            <div class="card-body p-3 d-flex align-items-center">
                                <i class="fa fa-money-bill-alt p-3 font-2xl mr-3"
                                   style="background-color:#0e4d22; color:#ffffff"></i>
                                <div>
                                    <div class="text-value-sm" style="color:#0e4d22; font-size:1.5em">
                                        &#8369; {{ number_format($income["totalIncome"], 2) }}</div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card">
                            <div class="card-body p-3 d-flex align-items-center">
                                <i class="fa fa-gem p-3 font-2xl mr-3"
                                   style="background-color:#0e4d22; color:#ffffff"></i>
                                <div>
                                    <div class="text-value-sm" style="color:#0e4d22; font-size:1.1em"><span
                                            style="font-size:0.8em">Sent:</span> <span
                                            id="winners-gem-sent">{{ number_format($income["totalGemsSent"], 2) }}</span>
                                        <i class="fas fa-gem" style="font-size:0.7em"></i></div>
                                    <div class="text-value-sm" style="color:#0e4d22; font-size:1.1em; margin-top:-6px">
                                        <span
                                            style="font-size:0.8em">Received:</span> {{ number_format($income["totalGemsReceived"], 2) }}
                                        <i class="fas fa-gem" style="font-size:0.7em"></i></div>
                            ...
                            <div class="card-footer px-3 py-2">
                                <a class="btn-block text-muted d-flex justify-content-between align-items-center"
                                   href="javascript:void(0)" data-toggle="modal" data-target="#modal-transfer">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card">
                            <div class="card-body p-3 d-flex align-items-center">
                                ...
                                <div>
                                    <div class="text-value-sm"
                                         style="color:#0e4d22; font-size:1.5em">{{ number_format(Auth::user()->monthlyPVMaintenance()) }}
                                        / {{ number_format(Auth::user()->requiredPVMaintenance()) }}</div>
                                    <div class="text-muted text-uppercase font-weight-bold small"
                                         style="font-size:0.75em">Monthly PV Maintenance
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer px-3 py-2">
                                <a class="btn-block text-muted d-flex justify-content-between align-items-center"
                                   href="javascript:void(0)" data-toggle="modal"
                                   data-target="#modal-pv-maintenance-details">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card">
                            <div class="card-body p-3 d-flex align-items-center">
                                <i class="fa fa-trophy p-3 font-2xl mr-3"
                                   style="background-color:#0e4d22; color:#ffffff"></i>
                                <div>
                                    <div class="text-value-sm"
                                         style="color:#0e4d22; font-size:1.3em; line-height:20px">{{ Auth::user()->packageAndRank() }}</div>
                                    <div class="text-muted text-uppercase font-weight-bold small"
                                         style="line-height:24px">Rank Status
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer px-3 py-2">
                                <div class="btn-block text-muted d-flex justify-content-between align-items-center">
                                    <span
                                        class="small font-weight-bold">Rank Points: {{ number_format(Auth::user()->totalRankPoints(), 2) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card">
                            <div class="card-body p-3 d-flex align-items-center">
                                <i class="fa fa-money-bill-wave p-3 font-2xl mr-3"
                                   style="background-color:#0e4d22; color:#ffffff"></i>
                                <div>
                                    <div class="text-value-sm" style="color:#0e4d22; font-size:1.5em">&#8369; <span
                                            id="pool-share-amount">{{ number_format(totalPoolShares(), 2) }}</span>
                                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card">
                            <div class="card-body p-3 d-flex align-items-center">
                                <i class="fa fa-users p-3 font-2xl mr-3"
                                   style="background-color:#0e4d22; color:#ffffff"></i>
                                <div>
                                    <div class="text-value-sm" style="color:#0e4d22; font-size:1.1em"><span
                                            style="font-size:0.8em">Downlines:</span> {{ number_format(Auth::user()->downlineCount())  }}
                                    </div>
                                    <div class="text-value-sm" style="color:#0e4d22; font-size:1.1em; margin-top:-6px">
                                        <span
                                            style="font-size:0.8em">Referral Code:</span> {{ Auth::user()->referral_code  }}
                                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card text-white bg-purple">
                            ...
                            <div class="card-footer bg-purple px-3 py-2">
                                <a class="btn-block text-muted d-flex justify-content-between align-items-center"
                                   href="https://8fairwin8tradingcorp.com/login">
