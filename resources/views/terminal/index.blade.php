                ...
                <div class="table-responsive mt-1">
                    ...
                    <table class="table table-bordered data-table font-size-90" style="display:none">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="pt-2">
                                    <button class="btn btn-custom-2 btn-sm mt-1 font-size-90 terminal-view-items" value="{{ $order["id"] }}" data-reference="{{ $order["reference"] }}" style="width:83px">Items</button>
                ...
                <div class="table-responsive mt-4">
                    ...
                    <table class="table table-bordered data-table font-size-90" style="display:none">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <button class="btn btn-custom-2 btn-sm font-size-90 mt-1 terminal-view-items" value="{{ $order["id"] }}" data-reference="{{ $order["reference"] }}" style="width:82px">Items</button>
