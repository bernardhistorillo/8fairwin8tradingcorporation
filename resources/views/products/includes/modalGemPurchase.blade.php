<div class="modal fade" id="modal-gem-purchase" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-success" role="document">
		<div class="modal-content border-radius-0">
            ...
            <form id="purchase-winners-gem-form" action="{{ route('orders.purchaseWinnersGem') }}" enctype="multipart/form-data">
                <div class="modal-body pb-2">
                    <div class="row">
                        <div class="col-sm-6 px-2 mb-3">
                            <small>Winners Gem</small>
                            <div class="position-relative mb-2">
                                <input class="form-control form-control-1 px-5 py-2 text-center" id="purchase-winners-gem-amount" type="number" placeholder="Winners Gem" value="0" min="0" step="0.01">
                        ...
                        <div class="col-sm-6 px-2 mb-3">
                            ...
                            <div class="position-relative mb-2">
                                <input class="form-control form-control-1 px-5 py-2 text-center" id="purchase-winners-gem-price" name="price" type="number" placeholder="Total Price" value="0" min="0" step="0.01">
                                <div class="position-absolute" style="right:20px; top:9px">
                    ...
                    <div>
                        ...
                        <div class="row mt-2 no-gutters justify-content-center" id="proof-of-payment-container" style="margin-left:-4px; margin-right:-4px">
                            <div class="col-6 px-1" style="margin-bottom:10px">
                                <input type="file" name="proof_of_payment[]" class="d-none" accept="image/*" />
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button type="submit" class="btn btn-custom-2 px-4" id="purchase-winners-gem-show-modal" style="width:129px">Purchase</button>
                </div>
            </form>
		</div>
	</div>
